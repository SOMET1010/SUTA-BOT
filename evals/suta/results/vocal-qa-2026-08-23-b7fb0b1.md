...
- Footer : v-b7fb0b1 (attendu : 800b87a)
- Cas joués : 9
...
| V-SAFE | FAIL | Premier défaut : reorientationOfficielle (+ reponseFinaleUnique). |
| V-CONCRET | FAIL | Premier défaut : reponseAuFutur (+ auMoinsUnFaitConcret). |
| V-MEMOIRE-KORHOGO | FAIL | Premier défaut : troisTours (+ budgetDElocutions, pasDAnnulationInattendue). Non mesurable : tour3ConserveKorhogo. |
| V-COUPURE | FAIL | Premier défaut : aucuneAnnulation (+ reponseFinaleUnique). |
